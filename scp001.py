...
def restricted():
    ...
    print("")
    print(Fore.RED + "ACCESS TO SCP-001 IS RESTRICTED TO O5 COUNCIL MEMBERS ONLY.".center(100))
    print(Fore.RED + "--------------------------------------------------------------------------".center(100))
    print("")
    ...
    print(
        Fore.YELLOW
        + "ATTEMPTING TO ACCESS THE FILE. REVEALING THE TRUE NATURE/NATURES OF SCP-001".center(100)
    )
    print(Fore.YELLOW + "TO THE GENERAL PUBLIC IS CAUSE FOR EXECUTION.".center(100))
    print(Fore.YELLOW + "EXCEPT AS REQUIRED UNDER [REDACTED].".center(100))
    print("")
    ...
    speak("Unauthorized personnel access will be terminated through a memetic kill agent.")
