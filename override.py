...
print("")
casper_speak("Enter security override code")
override_code = input(Fore.RED + "       Enter security override code: ")
if override_code == "omega casper 212":
    ...
    casper_speak("Override code accepted")
    ...
    print("")
    print("      ", Fore.BLACK + Back.RED + " OVERRIDE CODE NOT ACCEPTED ")
    casper_speak("OVERRIDE CODE NOT ACCEPTED")
    print("")
    print(Fore.RED + "       <<< INITIATING TERMINAL LOCKOUT >>>")
    casper_speak("INITIATING TERMINAL LOCKOUT")
    lock_protocol()
