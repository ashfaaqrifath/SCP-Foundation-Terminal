...
COMMAND_MENU = {
    ...
    "(4) Help": "help",
    "(5) Emergency lockout": "lock",
    "(6) Enable incognito mode": "incog",
    "(7) Disable incognito mode": "dis",
    "(8) Delete activity logs": "clean",
    "(9) Register new user": "reg",
    "(10) Display profile": "profile",
    "(11) Clear terminal": "clear",
    "(12) Exit": "exit",
}
